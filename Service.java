...
public class Service {
    ...
    public static void work() {
        ...
        int number, num, numberSearch, numNew;
        ...
        switch (number) {
            ...
            case 2:
                ...
                numberSearch = Integer.parseInt(in.nextLine());
                    ...
                    if (numNew == 2) {
                        ...
                        switch (numCor) {
                            ...
                            case 1:
                                ...
                                } else personNew.setPhone(phoneCor);
            ...
            case 5:
                ...
                if (personToCorrect != null) {
                    ...
                    if (numToCorrect == 2) {
                        System.out.println("Какой параметр редактируем? " +
                                "1 - имя и фамилию, 2 - электронную почту, 3 - адрес проживания.");
                        int numCor = Integer.parseInt(in.nextLine());
                        switch (numCor) {
                            // редактируем имя и фамилию
                            case 1:
                                ...
                                System.out.println("Введите новую фамилию: ");
                                String surnameCor = in.nextLine();
                                personToCorrect.setName(nameCor);
                                personToCorrect.setSurname(surnameCor);
                                personToCorrect.Print();
                                System.out.println(" ");
                                System.out.println("1 - вернуться в главное меню");
                                num = Integer.parseInt(in.nextLine());
                                ...
                                // редактируем почту
                            case 2:
                                System.out.println(personToCorrect.getEmail());
                                List<String> emailNew = personToCorrect.getEmail();
                                System.out.println("Введите порядковый номер почты:");
                                int emailNumber = Integer.parseInt(in.nextLine());
                                emailNumber = emailNumber - 1;
                                System.out.println("Введите новую почту:");
                                String emailCor = in.nextLine();
                                emailNew.set(emailNumber, emailCor);
                                personToCorrect.setEmail(emailNew);
                                personToCorrect.Print();
                                System.out.println(" ");
                                System.out.println("1 - вернуться в главное меню");
                                num = Integer.parseInt(in.nextLine());
                            ...
                            case 3:
                                System.out.println("Введите новый адрес: ");
                                String addressCor = in.nextLine();
                                personToCorrect.setAddress(addressCor);
                                personToCorrect.Print();
                                break;
                        }
                    }
